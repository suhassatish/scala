...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(tw => google.exists(googleWord => tw.text.contains(googleWord)))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(tw => apple.exists(appleWord => tw.text.contains(appleWord)))
